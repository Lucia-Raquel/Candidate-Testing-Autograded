...
function gradeQuiz(candidateAnswers) {
  ...
  grade = (grade)/(numQuestions)*100;  //TODO 3.2 use this variable to calculate the candidates score.
    if (grade >= 80) {
  console.log(`You passed! Your score is ${grade}% out of 100%!`);
} else if (grade < 80) {
  console.log(`You failed. Your score is ${grade}% out of 100%.`);
}
  return grade;
}
